...
func containsIntegerTheory(term Term[BoolSort]) bool {
	...
	case IntegerLinearEquality, IntegerLinearDisequality, IntegerLinearChoice, integerLinearStrictBound, IntegerDivModRelation, IntegerDivModSystem:
		return true
	case IntegerProductRelation, IntegerProductSystem, IntegerAffineProductRelation, IntegerAffineProductSystem, IntegerAffineCubeRelation, IntegerAffineCubeSystem, IntegerAffineCubeBound, IntegerAffineCubeBoundSystem, IntegerAffinePowerRelation, IntegerAffinePowerSystem, IntegerAffinePowerBound, IntegerAffinePowerBoundSystem, IntegerAffineTwoSquareRelation, IntegerAffineTwoSquareSystem, IntegerAffineTwoSquareBound, IntegerAffineTwoSquareBoundSystem, IntegerAffineThreeSquareRelation, IntegerAffineThreeSquareSystem, IntegerAffineThreeSquareBound, IntegerAffineThreeSquareBoundSystem, IntegerAffineFourSquareRelation, IntegerAffineFourSquareSystem, IntegerAffineFourSquareBound, IntegerAffineFourSquareBoundSystem, IntegerSquareBound, IntegerSquareSystem, IntegerAffineSquareBound, IntegerAffineSquareSystem, IntegerProductBound, IntegerProductBoundSystem, IntegerAffineProductBound, IntegerAffineProductBoundSystem:
		return true
