...
const (
	udpECNSupport = true
	// Darwin accepts source addresses from the loopback prefix even when they
	// were not explicitly bound to the socket, so invalid-source rejection is
	// not portable enough to assert here.
